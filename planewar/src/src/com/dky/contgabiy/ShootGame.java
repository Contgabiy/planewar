...
public class ShootGame extends JPanel {
	...
	static {
		try {
			background = ImageIO.read(ShootGame.class.getResource("image/background.jpg"));
	...
	public static void main(String[] args) {
		...
		JFrame frame = new JFrame("Contgabiy");
	...
	public static FlyingObject nextOne() {
		...
		return (FlyingObject)(new Airplane());
	}
}
